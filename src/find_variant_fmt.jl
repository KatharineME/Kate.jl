...
function find_variant(
    ...
    manta_runworkflow_py = joinpath(manta_dir, "runWorkflow.py",)
    ...
    strelka_runworkflow_py = joinpath(strelka_dir, "runWorkflow.py",)
    ...
    stats_csv = joinpath(snpeff_dir, "stats.csv",)
